    ...
    Menu(): void {
        ...
        while (true) {
            const opcoes = [
                ...
                '6. Curtir postagem',// Não esta atribuindo ao contador de uma postagem ao curtir uma pstaegm pelo ID
                '7. Descurtir postagem',// Não testei
                '8. Decrementar Visualização',// Não testei
                '9. Sair',
            ];
